...
const PaymentFail = ({ clearOrderSummayInfo, getProfileDetails }) => {
  useEffect(() => {
      ...
      <Container fluid className="page-not-found" style={{ marginTop: getBannerMarginTop(30, -20) }}>
        <Row>
          <Col lg="10" className="midHolder">
            <img src={`${IMAGES.PAYMENT_FAIL}`} alt="unknown" className="img-fluid" />
...
export default connect(null, mapDispatchToProps)(PaymentFail);
